...
Lucas Bittencourt Rauch e Caio Rosa
...
- Rode 'npm run web_dev' para executar o frontend
- Rode 'npm run api_dev' para executar o backend
  Obs: Rode o frontend e a api em terminais separados
