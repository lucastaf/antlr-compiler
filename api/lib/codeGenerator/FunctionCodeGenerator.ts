import type { ASTExpressionNode, FunctionCallNode } from "../abstractSyntaxTree/AstExpressionNode";
import { CodeScopeNode, ReturnNode } from "../abstractSyntaxTree/AstNode";
