...
public class FileScriptParser extends Parser {
	...
	public static final int
		...
		RULE_comando_atribuicao = 4, RULE_comando_atribuicao_array = 5, RULE_comando_declaracao = 6, 
		RULE_if_stmt = 7, RULE_elseif = 8, RULE_else = 9, RULE_loop = 10, RULE_while_loop = 11, 
		RULE_do_while_loop = 12, RULE_for_loop = 13, RULE_comandos_function = 14, 
		RULE_function_decl = 15, RULE_lista_parametros = 16, RULE_return_stmt = 17, 
		...
		RULE_valor_calculo = 36, RULE_array_access = 37, RULE_lista_expressoes = 38, 
		RULE_array = 39, RULE_function_call = 40;
	...
	public static class ComandoContext extends ParserRuleContext {
		...
		public Comando_atribuicao_arrayContext comando_atribuicao_array() {
			return getRuleContext(Comando_atribuicao_arrayContext.class,0);
		}
	...
	@SuppressWarnings("CheckReturnValue")
	public static class Comando_atribuicao_arrayContext extends ParserRuleContext {
		...
		public Comando_atribuicao_arrayContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_comando_atribuicao_array; }
	}

	public final Comando_atribuicao_arrayContext comando_atribuicao_array() throws RecognitionException {
		Comando_atribuicao_arrayContext _localctx = new Comando_atribuicao_arrayContext(_ctx, getState());
		enterRule(_localctx, 10, RULE_comando_atribuicao_array);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(116);
	...
	public final Comando_declaracaoContext comando_declaracao() throws RecognitionException {
		...
		enterRule(_localctx, 12, RULE_comando_declaracao);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(120);
	...
	public final Comandos_functionContext comandos_function() throws RecognitionException {
		...
		enterRule(_localctx, 28, RULE_comandos_function);
		try {
			setState(168);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final Array_accessContext array_access() throws RecognitionException {
		...
		enterRule(_localctx, 74, RULE_array_access);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(308);
