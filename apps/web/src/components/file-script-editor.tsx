...
import { registerFileScriptLanguage } from '../lib/file-script-language'

interface Props {
  content: string
  onContentChange: (content: string) => void
  /** Called after each compile — passes refs so App can set markers */
  onEditorMount: (editor: monaco.editor.IStandaloneCodeEditor, monacoInstance: typeof monaco) => void
}

export default function CodeEditor({ content, onContentChange, onEditorMount }: Props) {
