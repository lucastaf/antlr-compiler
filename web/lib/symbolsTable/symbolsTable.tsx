...
export default function SymbolTable(props: {
  variables: VariableDeclare[] | null | undefined;
}) {
    ...
    <div className="flex flex-col h-full overflow-hidden">
      ...
      {isEmpty ? (
        ...
        <div className="flex-1 flex flex-col items-center justify-center gap-2 px-4 text-center">
          ...
          <p className="text-[11px] text-[#4e4e4e] leading-relaxed">
            Execute o código para inspecionar as variáveis
          </p>
        </div>
      ) : (
        /* Symbol cards */
          ...
          {variables.map((v, i) => (
            ...
            >
              <div className="flex items-center justify-between gap-2">
                <span className="text-sm font-mono text-[#d4d4d4] truncate">
                  {v.name}
                </span>
                {v.isConst ? (
